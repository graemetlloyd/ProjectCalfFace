...
# Write MRP to file:
WriteMatrixNEXUS(MRP, "~/Documents/Publications/in prep/Synapsid metatree - Spencer/ProjectCalfFace/MRP/Constraint_2020amrp.nex")
