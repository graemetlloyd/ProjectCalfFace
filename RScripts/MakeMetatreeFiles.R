...
# Set inclsuive data list less files already on repository:
InclusiveDataList <- setdiff(InclusiveDataList, gsub(".xml", "", list.files("~/Documents/Publications/in prep/Synapsid metatree - Spencer/ProjectCalfFace/XML/")))
